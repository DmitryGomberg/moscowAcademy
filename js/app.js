(() => {
    ...
    class Popup {
        ...
        _focusTrap() {
            ...
            if (!this.isOpen && this.lastFocusEl) this.lastFocusEl.focus(); else if (focusable.length) focusable[0].focus();
        }
    ...
    function initSliders() {
        ...
        if (document.querySelector(".clients__slider")) clientsSlider1 = new swiper_core_Swiper(".clients__slider", {
        ...
        if (document.querySelector(".clients__slider2")) clientsSlider2 = new swiper_core_Swiper(".clients__slider2", {
            modules: [ Controller ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".results__slider")) new swiper_core_Swiper(".results__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            navigation: {
                prevEl: ".swiper-button-prev-results",
                nextEl: ".swiper-button-next-results"
            },
            breakpoints: {
                700: {
                    slidesPerView: 2,
        ...
        if (document.querySelector(".letters__slider")) new swiper_core_Swiper(".letters__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            navigation: {
                prevEl: ".swiper-button-prev-letters",
                nextEl: ".swiper-button-next-letters"
            },
            breakpoints: {
                700: {
                    slidesPerView: 2,
        ...
        clientsSlider1.controller.control = clientsSlider2;
        clientsSlider2.controller.control = clientsSlider1;
    }
...
***************************************************************************** */
    ...
    var LightGallery = function() {
        ...
        LightGallery.prototype.addHtml = function(index) {
            ...
            if (!subHtmlUrl) if (subHtml) {
                ...
                if (fL === "." || fL === "#") try {
                    if (this.settings.subHtmlSelectorRelative && !this.settings.dynamic) subHtml = $LG(this.items).eq(index).find(subHtml).first().html(); else subHtml = $LG(subHtml).first().html();
                } catch (error) {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        const firstCard = document.querySelector(".card-advantages");
        if (!firstCard) return;
        const observer = new IntersectionObserver((entries, obs) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    entry.target.classList.add("animate-arrow");
